  ...
  <div class="comments-wrap">
    ...
    <div v-else-if="commentStatus === 'open'" class="comment-from">
      ...
      <div class="comment-form-content">
        <span for="content">内容<i class="c-red">*</i></span>
        <a-textarea id="content" name="content" v-model="content.value" rows="8" cols="80" @keyup="_contentValidate"></a-textarea>
      ...
      <div class="submit-wrap" @click.prevent="bSubmit && _postComment()">
        ...
        <a-input type="submit" class="submit-btn" :value="submitText"/>
      </div>
    </div>
    <!-- 评论列表 -->
        ...
        <div class="list-footer">
          ...
          <div class="opinion">
            <span class="opinion-btn" @click="_updateCommentOpinion(item.id, 'good', index)">
              <a-icon type="like" /> {{ item.meta.opinion.good }}
            </span>
            <span class="opinion-btn" @click="_updateCommentOpinion(item.id, 'bad', index)">
              <a-icon type="dislike" /> {{ item.meta.opinion.bad }}
            </span>
          </div>
        </div>
...
<style lang="less" src="../../assets/css/comment.less" scoped></style>
